...
class Events
{
    ...
    public static function onWorkerStart($worker)
    {
        if (empty(self::$db)) {
            ...
            self::$db = new \Workerman\MySQL\Connection('127.0.0.1', '3306', 'root', 'Byt2018!', 'whisper');
	}
    ...
    {
        file_put_contents('/var/www/lnmp/html/whisper/runtime/message.json', $client_id  . ':' . $message . "\r\n", FILE_APPEND);
